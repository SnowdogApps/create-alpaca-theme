...
export async function addBaseStyles(themeName, vendor) {
  ...
  await addFilesFromDir(ENV_PATH.ALPACA_MAGENTO_CHECKOUT_STYLES_DIR, themeName, '_', vendor, MAGENTO_CHECKOUT_STYLES)
  await prependImport(chechoutPath, checkoutText, themeName, null, 'variables', 'YOUR_THEME_NAME')

  // CREATING THEME LEVEL STYLES
  await addFilesFromDir(ENV_PATH.ALPACA_STYLES_DIR, themeName, 'email|gallery', vendor, '/styles')
